...
export class OutfitSuggestionService {
  ...
  async generateOutfitSuggestion(input: OutfitSuggestionInput): Promise<OutfitSuggestion> {
    try {
  ...
  private createOutfitPrompt(input: OutfitSuggestionInput): string {
...
`;
  ...
  private parseAIResponse(aiResponse: string, input: OutfitSuggestionInput): OutfitSuggestion {
    try {
  ...
  private parseTextResponse(text: string, input: OutfitSuggestionInput): OutfitSuggestion {
  ...
  private mapToCategory(item: string): string {
  ...
  private extractStyle(text: string): string | null {
  ...
  private generateSearchTerms(description: string, category: string): string[] {
